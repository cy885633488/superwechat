...
public class GroupSimpleDetailActivity extends BaseActivity {
	...
	private NetworkImageView publicGroupAvatar;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		publicGroupAvatar = (NetworkImageView) findViewById(R.id.avatar);
...
//		}).start();
     ...
     private void showGroupDetail() {
		 ...
		 UserUtils.setGroupBeanAvatar(groupid,publicGroupAvatar);
     }
